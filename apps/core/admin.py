...
from .models import Service, Event, EventGallery, Review
...
class EventAdmin(admin.ModelAdmin):
    ...
    list_filter = ('created_at', 'services', 'is_active', RatingFilter)
    ...
    inlines = [EventGalleryInline, ReviewInline]
...
class EventGalleryAdmin(admin.ModelAdmin):
    list_display = ('id', 'event', 'is_primary', 'uploaded_at', 'preview_image', 'caption_preview')  
    list_display_links = ('id', 'event')
    list_filter = ('event__brand_name', 'uploaded_at', 'is_primary')
    search_fields = ('event__brand_name', 'caption')
